...
for category, cases in test_suite.items():
    ...
    report_md.append('| Cấp độ | Lệnh thoại | STT Latency | Intent Latency | Gemini/App Latency | Action Finish | TTFB (Gói 1) | Tổng thời gian | Status |')
    report_md.append('| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |')
    
    for level, img_path, text in cases:
        time.sleep(2.5) # Avoid hitting free tier rate limits
